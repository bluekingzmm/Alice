...
public class Aftertomorrowtwo extends TemplateElement {
	/*
	 * 大后天天气预报，匹配第二个*
	 */
	private int index;
	...
	public Aftertomorrowtwo(int index) {
		this.index = index;
	}

	public Aftertomorrowtwo() {

	}

	public Aftertomorrowtwo(Attributes attributes) {
