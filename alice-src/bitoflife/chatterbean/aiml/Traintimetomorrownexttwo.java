...
public class Traintimetomorrownexttwo extends TemplateElement {
	/*
	 * *后天火车票余票
	 */
	...
	public Traintimetomorrownexttwo(int index,int indextwo) {
		this.index = index;
		this.indextwo=indextwo;
	}

	public Traintimetomorrownexttwo() {

	}

	public Traintimetomorrownexttwo(Attributes attributes) {
	
		String value1 = attributes.getValue(1);
		index = (value1 != null ? Integer.parseInt(value1) : 2);
		
		String value2 = attributes.getValue(2);
		indextwo = (value2 != null ? Integer.parseInt(value2) : 3);
	}
		...
		try {
			...
			String t1=w1.replace("+", "");
				...
				sb = new StringBuilder();
				 url = "http://api.jisuapi.com/train/ticket?appkey=38d79f3a989e19a3%20&start="+t+"&end="+t1+"&date="+dateString+"";
