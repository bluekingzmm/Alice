...
public class Eval extends TemplateElement
{
  /*
  Constructor Section
  */

  public Eval(Attributes attributes)
  {
  }
  
  public Eval(Object... children)
  {
    super(children);
  }

  public Eval(int index)
  {
    super(new Eval(index));
  }
  ...
  */
  ...
  {
    return "<eval>" + super.toString() + "</eval>";
  }
}
