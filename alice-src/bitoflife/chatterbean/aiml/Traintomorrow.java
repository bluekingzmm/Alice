...
public class Traintomorrow extends TemplateElement {
	/*
	 * 明天火车票余票
	 */
	...
	public Traintomorrow(int index, int indextwo) {
		this.index = index;
		this.indextwo = indextwo;
	}

	public Traintomorrow() {

	}

	public Traintomorrow(Attributes attributes) {
