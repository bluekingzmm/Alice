...
public class Traintimetomorrowtwo extends TemplateElement {
	/*
	 * *明天火车票余票
	 */
	...
	public Traintimetomorrowtwo(int index,int indextwo) {
		this.index = index;
		this.indextwo=indextwo;
	}

	public Traintimetomorrowtwo() {

	}

	public Traintimetomorrowtwo(Attributes attributes) {
