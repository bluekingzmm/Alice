...
public class Gushi extends TemplateElement {
	/*
	 * 输入关键字查找词语
	 */
	private int index;
	...
	public Gushi(Attributes attributes) {
	...
	public String process(Match match) {
		...
		try {
			...
			String t = w.replace("+", "");
			 url = "http://api.avatardata.cn/TangShiSongCi/Search?key=aac65830fc9e4d0baa45749aae042843&keyWord="+t+"";
